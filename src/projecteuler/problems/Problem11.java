 ...
 * @author Branimir
 */
public class Problem11 implements ProjectEulerProblem {
...
{1, 70, 54, 71, 83, 51, 54, 69, 16, 92, 33, 48, 61, 43, 52, 1, 89, 19, 67, 48}};
    ...
    public String description() {
        return "Problem 11: In the 20×20 grid below, four numbers along a diagonal line have been marked in red.\n"
                + "\n"
    ...
    public String solve() {
        ...
        for(int i = 0; i < grid.length; i++) {
            for(int j = 0; j + 3 < grid[i].length; j++){
